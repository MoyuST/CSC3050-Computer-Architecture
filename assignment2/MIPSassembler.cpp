...
int mispAssemble(int argc, char argv1[], char argv2[]){
    ...
    out_path = newaddress(argv1, argv2); //create the address for outfile
    ...
    firstscan(argv1, labels, numOfCounter);
